...
class appDevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/userlocal')) {
            // userlocal_index
            if (rtrim($pathinfo, '/') === '/userlocal') {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_userlocal_index;
                }

                if (substr($pathinfo, -1) !== '/') {
                    return $this->redirect($pathinfo.'/', 'userlocal_index');
                }

                return array (  '_controller' => 'AppBundle\\Controller\\UserController::indexAction',  '_route' => 'userlocal_index',);
            }
            not_userlocal_index:

            // userlocal_new
            if ($pathinfo === '/userlocal/new') {
                if (!in_array($this->context->getMethod(), array('GET', 'POST', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'POST', 'HEAD'));
                    goto not_userlocal_new;
                }

                return array (  '_controller' => 'AppBundle\\Controller\\UserController::newAction',  '_route' => 'userlocal_new',);
            }
            not_userlocal_new:

            // userlocal_show
            if (preg_match('#^/userlocal/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_userlocal_show;
                }

                return $this->mergeDefaults(array_replace($matches, array('_route' => 'userlocal_show')), array (  '_controller' => 'AppBundle\\Controller\\UserController::showAction',));
            }
            not_userlocal_show:

            // userlocal_edit
            if (preg_match('#^/userlocal/(?P<id>[^/]++)/(?P<cls>[^/]++)/edit$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('GET', 'POST', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'POST', 'HEAD'));
                    goto not_userlocal_edit;
                }

                return $this->mergeDefaults(array_replace($matches, array('_route' => 'userlocal_edit')), array (  'cls' => 0,  '_controller' => 'AppBundle\\Controller\\UserController::editAction',));
            }
            not_userlocal_edit:
            ...
            if (preg_match('#^/userlocal/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                if ($this->context->getMethod() != 'DELETE') {
                    $allow[] = 'DELETE';
                    goto not_userlocal_delete;
                }

                return $this->mergeDefaults(array_replace($matches, array('_route' => 'userlocal_delete')), array (  '_controller' => 'AppBundle\\Controller\\UserController::deleteAction',));
            }
            not_userlocal_delete:
        ...
        if (0 === strpos($pathinfo, '/connect')) {
            ...
            if ($pathinfo === '/connect/facebook') {
                return array('_route' => 'hwi_oauth_facebook_login');
            }
